  ...
  <div class="sticky z-10 top-0 h-12 border-b bg-white lg:py-2">
    <div class="px-3 flex items-center justify-between space-x-4 2xl:container">
      ...
      <div class="flex space-x-4">
        ...
        <div hidden class="md:block">
          ...
          >
            ...
            <input
              ...
              class="w-full pl-14 pr-4 py-1.5 rounded-xl text-sm text-gray-600 outline-none border border-gray-300 focus:border-cyan-300 transition"
            />
          </div>
        </div>
        <!--/search bar -->
        <button
          aria-label="search"
          class="w-8 h-8 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200 md:hidden"
        >
          <svg
